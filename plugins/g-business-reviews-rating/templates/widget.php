...
?>
	<div class="<?php echo esc_attr($this->reference)	; ?>">
        <p>
            <label for="<?php echo esc_attr($this->get_field_name('title')); ?>"><?php echo esc_attr(_e('Title:')); ?></label>
        ...
        <p class="business-name"><?php echo (($this->business_icon != NULL) ? '<span class="icon"><img src="' . esc_attr($this->business_icon) . '" alt="' . esc_attr($this->business_name . ' ' . __('Icon')) . '"></span>' : '') . esc_html($this->business_name); ?></p>
	    <p class="plugin-attribution"><span class="powered-by-google"></span></p>
        <p class="theme">
            <label for="<?php echo esc_attr($this->get_field_name('theme')); ?>"><?php echo esc_attr(_e('Theme:')); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id('theme')); ?>" name="<?php echo esc_attr($this->get_field_name('theme')); ?>">
                <option value=""<?php echo ($theme == NULL) ? ' selected' : ''; ?>><?php echo esc_html(__('Default')); ?></option>
<?php
...
?>
        ...
        <p class="limit">
			<label for="<?php echo esc_attr($this->get_field_name('limit')); ?>"><?php echo esc_attr(_e('Review Limit:')); ?></label>
        ...
        <p class="sort">
			<label for="<?php echo esc_attr($this->get_field_name('sort')); ?>"><?php echo esc_attr(_e('Review Sort:')); ?></label>
...
?>
        ...
        <p>
			<label for="<?php echo esc_attr($this->get_field_name('offset')); ?>"><?php echo esc_attr(_e('Review Offset:')); ?></label>
        ...
        <p class="rating">
			<label for="<?php echo esc_attr($this->get_field_name('rating_min')); ?>"><?php echo esc_attr(_e('Rating Range:')); ?></label>
        ...
        <p class="language">
            <label for="<?php echo esc_attr($this->get_field_name('language')); ?>"><?php echo esc_attr(_e('Review Text Language:')); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id('language')); ?>" name="<?php echo esc_attr($this->get_field_name('language')); ?>">
                <option value=""<?php echo ($language == NULL) ? ' selected' : ''; ?>><?php echo esc_html(__('Any Language')); ?></option>
<?php
...
?>
        ...
        <p class="review-text-length">
			<label for="<?php echo esc_attr($this->get_field_name('review_text_min')); ?>"><?php echo esc_attr(_e('Review Text Length Range:')); ?></label>
        ...
        <p class="excerpt-length">
			<label for="<?php echo esc_attr($this->get_field_name('excerpt_length')); ?>"><?php echo esc_attr(_e('Review Excerpt Length:')); ?></label>
        ...
        <p class="language">
            <label for="<?php echo esc_attr($this->get_field_name('more')); ?>"><?php echo esc_attr(_e('More Text:')); ?></label>
        ...
        <p>
			<input class="checkbox" type="checkbox" id="<?php echo esc_attr($this->get_field_id('display_name')); ?>" name="<?php echo esc_attr($this->get_field_name('display_name')); ?>" value="1"<?php echo (($display_name) ? ' checked="checked"' : ''); ?>> <label for="<?php echo esc_attr($this->get_field_id('display_name')); ?>"><?php echo esc_attr(_e('Display business name')); ?></label><br>
			<input class="checkbox" type="checkbox" id="<?php echo esc_attr($this->get_field_id('display_icon')); ?>" name="<?php echo esc_attr($this->get_field_name('display_icon')); ?>" value="1"<?php echo (($display_icon) ? ' checked="checked"' : ''); ?>> <label for="<?php echo esc_attr($this->get_field_id('display_icon')); ?>"><?php echo esc_attr(_e('Display icon')); ?></label><br>
			<input class="checkbox" type="checkbox" id="<?php echo esc_attr($this->get_field_id('display_rating')); ?>" name="<?php echo esc_attr($this->get_field_name('display_rating')); ?>" value="1"<?php echo (($display_rating) ? ' checked="checked"' : ''); ?>> <label for="<?php echo esc_attr($this->get_field_id('display_rating')); ?>"><?php echo esc_attr(_e('Display rating')); ?></label><br>
			...
			<input class="checkbox" type="checkbox" id="<?php echo esc_attr($this->get_field_id('display_review_count')); ?>" name="<?php echo esc_attr($this->get_field_name('display_review_count')); ?>" value="1"<?php echo (($display_review_count) ? ' checked="checked"' : ''); ?>> <label for="<?php echo esc_attr($this->get_field_id('display_review_count')); ?>"><?php echo esc_attr(_e('Display review count')); ?></label><br>
			<input class="checkbox" type="checkbox" id="<?php echo esc_attr($this->get_field_id('display_reviews')); ?>" name="<?php echo esc_attr($this->get_field_name('display_reviews')); ?>" value="1"<?php echo (($display_reviews) ? ' checked="checked"' : ''); ?>> <label for="<?php echo esc_attr($this->get_field_id('display_reviews')); ?>"><?php echo esc_attr(_e('Display reviews')); ?></label><br>
			<input class="checkbox" type="checkbox" id="<?php echo esc_attr($this->get_field_id('display_review_text')); ?>" name="<?php echo esc_attr($this->get_field_name('display_review_text')); ?>" value="1"<?php echo (($display_review_text) ? ' checked="checked"' : ''); ?>> <label for="<?php echo esc_attr($this->get_field_id('display_review_text')); ?>"><?php echo esc_attr(_e('Display review text')); ?></label><br>
			...
			<input class="checkbox" type="checkbox" id="<?php echo esc_attr($this->get_field_id('display_write_review_button')); ?>" name="<?php echo esc_attr($this->get_field_name('display_write_review_button')); ?>" value="1"<?php echo (($display_write_review_button) ? ' checked="checked"' : ''); ?>> <label for="<?php echo esc_attr($this->get_field_id('display_write_review_button')); ?>"><?php echo esc_attr(_e('Display write review button')); ?></label><br>
			<input class="checkbox" type="checkbox" id="<?php echo esc_attr($this->get_field_id('display_attribution')); ?>" name="<?php echo esc_attr($this->get_field_name('display_attribution')); ?>" value="1"<?php echo (($display_attribution) ? ' checked="checked"' : ''); ?>> <label for="<?php echo esc_attr($this->get_field_id('display_attribution')); ?>"><?php echo esc_attr(_e('Display attribution')); ?></label><br>
			<input class="checkbox" type="checkbox" id="<?php echo esc_attr($this->get_field_id('animate')); ?>" name="<?php echo esc_attr($this->get_field_name('animate')); ?>" value="1"<?php echo (($animate) ? ' checked="checked"' : ''); ?>> <label for="<?php echo esc_attr($this->get_field_id('animate')); ?>"><?php echo esc_attr(_e('Animate rating stars')); ?></label><br>
			<input class="checkbox" type="checkbox" id="<?php echo esc_attr($this->get_field_id('stylesheet')); ?>" name="<?php echo esc_attr($this->get_field_name('stylesheet')); ?>" value="1"<?php echo (($stylesheet) ? ' checked="checked"' : ''); ?>> <label for="<?php echo esc_attr($this->get_field_id('stylesheet')); ?>"><?php echo esc_attr(_e('Stylesheet active')); ?></label>
		</p>
        <p class="buttons"><a href="<?php echo esc_attr($this->plugin_settings_url); ?>" class="button button-secondary"><?php echo esc_html(__('Settings')); ?></a><?php echo ($this->demo) ? ' <a href="' . esc_attr($this->plugin_settings_url) . '" class="demo"><span class="dashicons dashicons-warning"></span> ' . __('Demo Mode') . '</a>' : ''; ?></p>
    </div>