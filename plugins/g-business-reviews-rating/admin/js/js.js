...
function google_business_reviews_rating_admin(popstate) {
	...
	google_business_reviews_rating_syntax_highlight();
...
function google_business_reviews_rating_message(message, type) {
	...
	var html = '<div id="google-business-reviews-rating-settings-message" class="notice ' + type + ' notice-' + type + ' is-dismissible">\n'
...
function google_business_reviews_rating_preview() {
	if (!jQuery('#google-business-reviews-rating-setup').length) {
		return;
	}
