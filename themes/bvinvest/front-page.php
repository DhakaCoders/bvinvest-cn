  ...
  <nav class="md-popup-main-nav clearfix">
    <ul class="clearfix">
      ...
      <li class="menu-item-has-children">
        <a href="#">te huur</a>
        <ul class="clearfix sub-menu ulc">
      ...
      <li><a href="#">Zacasa</a></li>
      <li><a href="#">verkocht & verhuurd</a></li>
      <li><a href="#">Kijdagen</a></li>
